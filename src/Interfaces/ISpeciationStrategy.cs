...
namespace SharpNeat.Core
{
        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        /// </summary>
        IList<ISpecie<TGenome>> InitializeSpeciation(IList<TGenome> genomeList, int specieCount);
        ...
        /// </summary>
        void SpeciateGenomes(IList<TGenome> genomeList, IList<ISpecie<TGenome>> specieList);
        ...
        /// offspring.
        /// </summary>
        void SpeciateOffspring(IList<TGenome> genomeList, IList<ISpecie<TGenome>> specieList);
    }
}
